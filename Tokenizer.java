...
public class Tokenizer {
    ...
    public static LinkedList<Token> tokenize(String file, Token environment) {
        ...
        Tokenizer t = new Tokenizer(src, file, environment, false);
        t.tokens.add(Token.EOS); // tokens + EOS
        ...
        return p.errors; // In order: errors, allocations, assemblies, tokens, EOS
    }
    ...
    private Tokenizer() { throw new Error("Do not use this constructor!"); }
    private Tokenizer(StringBuilder src, String file, Token env, boolean envUsed) {
                ...
                if(t == Token.DIR_INCLUDE) {
                    ...
                    if(incFile == null) { error("Invalid file name: "+next); }
                        ...
                        if(src == null) { error("Unable to process file: "+incFile); }
                            ...
                            Tokenizer p = new Tokenizer(src, incFile, environment, environmentUsed);
